...
# Configurar CORS para permitir requisições do Streamlit Cloud
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Em produção, substitua pelo domínio do seu Streamlit
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)

# Configurar pasta de arquivos
...
async def obter_dados_arquivo(nome_arquivo: str):
    ...
    try:
        ...
        # Extrair dados conforme a estrutura do dashboard
        pedidos = []
